...
public class UI {
    ...
    public static ChessPosition readChessPosition(Scanner sc) {
        try {
            ...
            throw new InputMismatchException("Error raading ChessPosition: value valid between a1 to h8");
        }
    ...
    //printa bonitinho como o enunciado
    private static void printPiece(ChessPiece piece, boolean background){

        if (background) System.out.print(ANSI_BLUE_BACKGROUND); //vai colorir o fundo das jogadas disponiveis
