...
public class ChessMatch {
    ...
    private void validateSourcePosition(Position position){
        ...
        if (currentPlayer != ( (ChessPiece) board.piece(position)).getColor()) throw new ChessException("This piece is not yours!");

        if (!board.piece(position).isThereAnyPossibleMove()) throw new ChessException("There is not possible moves for this pieces!");
    }

    private void validateTargetPosition(Position source, Position target) {
        if (!board.piece(source).possibleMove(target)) throw new ChessException("The piece can not move to target position!");
    }
    ...
    private void undoMove(Position source, Position target, Piece capturedPiece) {
        //desfazer o movimento para qnd for check
    ...
    private void nextTurn() {
        turn++;
        // expressao condicional termaria
